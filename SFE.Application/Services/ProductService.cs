...
public class ProductService
{
    ...
    public async Task SeedSampleDataAsync()
    {
        ...
        // Single canonical seed timestamp via ITimeProvider.
        var seedTime = _time.UtcNow.UtcDateTime;

        var catBoissons = new ProductCategory { Name = "Boissons", Color = "#3B82F6", Icon = "🥤", SortOrder = 1, CreatedAt = seedTime };
        var catAliments = new ProductCategory { Name = "Alimentation", Color = "#10B981", Icon = "🍞", SortOrder = 2, CreatedAt = seedTime };
        var catHygiene = new ProductCategory { Name = "Hygiène", Color = "#8B5CF6", Icon = "🧴", SortOrder = 3, CreatedAt = seedTime };
        var catServices = new ProductCategory { Name = "Services", Color = "#F59E0B", Icon = "🔧", SortOrder = 4, CreatedAt = seedTime };
        var catBureau = new ProductCategory { Name = "Fournitures bureau", Color = "#EF4444", Icon = "📎", SortOrder = 5, CreatedAt = seedTime };
